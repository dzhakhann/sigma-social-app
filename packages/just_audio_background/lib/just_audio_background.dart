...
class _PlayerAudioHandler extends BaseAudioHandler
  ...
  void _broadcastState() {
    // Sigmacta patch: media notification shows PREV · PLAY/PAUSE · NEXT only —
    // no stop square (users disliked it). Skip controls are always present so
    // the layout stays stable even on a single-item queue.
    final controls = [
